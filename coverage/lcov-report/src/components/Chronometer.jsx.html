...
<head>
    <title>Code coverage report for src/components/Chronometer.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/components</a> Chronometer.jsx</h1>
        <div class='clearfix'>
...
&nbsp;
&nbsp;
const Chronometer = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
    const {time } = <span class="cstat-no" title="statement not covered" >React.useContext(UserContext)</span>
