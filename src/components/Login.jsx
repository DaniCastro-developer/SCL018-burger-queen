...
const Login = () => {
  return <div className='flex-col justify-center'>
      <h2 className='text-4xl my-8 text-center' > Hola Bienvenides </h2>
     ...
     <div className='flex justify-center '>
      <Link to = {`/role`} > <button type="button" className="h-10 px-5 m-2 text-pink-100 transition-colors duration-150 bg-pink-500 rounded-lg focus:shadow-outline hover:bg-pink-600"> Comenzar </button> </Link>
      </div>
